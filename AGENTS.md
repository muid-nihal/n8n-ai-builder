# AGENTS.md - AI Agent Instructions for n8n Workflow Development

> **This file is identical to CLAUDE.md — it exists so that Codex (CLI and desktop) picks up project instructions automatically.**
> Codex reads AGENTS.md; Claude Code reads CLAUDE.md. Both files contain the same content.
> **Edit CLAUDE.md as the canonical source, then sync to AGENTS.md.**
